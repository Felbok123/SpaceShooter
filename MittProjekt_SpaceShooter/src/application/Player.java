...
public class Player extends SpriteBuild {
    ...
    Player(Pane pane, Image image, float x, float y, float r, float dx, float dy, float dr, float health,
    ...
    public void primaryWeaponCharge() {
        ...
        /* counter increased by this
         value every frame */
        float bulletCounterDelta = 0.905f;
    ...
    public float getPrimaryWeaponBulletCount() {
        // number of bullets ship shots at 1 time
        // right,left,center
        return (float) 7;
    }
